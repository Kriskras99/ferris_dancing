...
fn sgscontainer_parse_wiiu2016(_path: &Path, data: Vec<u8>) -> datatest_stable::Result<()> {
    sgs::parse_sgscontainer(&data)?;
    Ok(())
}
...
fn sgscontainer_parse_win2017(_path: &Path, data: Vec<u8>) -> datatest_stable::Result<()> {
    sgs::parse(&data)?;
    Ok(())
}
...
datatest_stable::harness!(
    sgscontainer_parse_wiiu2016,
    "files/wiiu2016",
    r".*/sgscontainer.ckd/.*",
    sgscontainer_parse_nx2017,
    "files/nx2017",
    r".*/sgscontainer.ckd/.*",
    sgscontainer_parse_win2017,
    "files/win2017",
    r".*/sgscontainer.ckd/.*",
