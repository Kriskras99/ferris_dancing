...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for Actor<'de> {
    fn deserialize_at_with_ctx(
        ...
        let components = reader
            .read_len_type_at_with_ctx::<u32be, _, _>(position, ugi)?
            .collect::<Result<_, _>>()?;
    ...
    fn deserialize_at_with_ctx(
        ...
        let component = match component_type {
            ...
            0x72B6_1FC5 => Component::MaterialGraphicComponent(
                reader.read_at_with_ctx(position, &(*ctx, false))?,
            ),
            // JD_Carousel
            ...
            0x0579_E81B => Component::PleoTextureGraphicComponent(
                reader.read_at_with_ctx(position, &(*ctx, true))?,
            ),
            // PropertyPatcher
            0xF719_B524 => {
...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for CreditsComponent<'de> {
    fn deserialize_at_with_ctx(
        ...
        let number_of_lines =
            usize::try_from(reader.read_at_with_ctx::<u32, _>(position, &BigEndian)?)?;
