...
use dotstar_toolkit_utils::{
    bytes::{
        endian::BigEndian, len::u32be, read::{BinaryDeserialize, ReadAtExt, ReadError}
    },
...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for Actor<'de> {
    fn deserialize_at_with_ctx(
        reader: &'de (impl ReadAtExt + ?Sized),
        position: &mut u64,
        ugi: &UniqueGameId,
    ) -> Result<Self, ReadError> {
    let unk0 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk0, &1u32)?;
    ...
    let unk2_5 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(
        &unk2_5,
        &[
            0x3EE7_720D,
    ...
    test_eq(&unk3, &0u64)?;
    let unk3_5 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk3_5, &0u32)?;
    match ugi.game {
        Game::JustDance2022 | Game::JustDance2021 | Game::JustDance2020 | Game::JustDance2019 => {
            let unk4 = reader.read_at_with_ctx(position, &BigEndian)?;
        ...
        _ => {
            ...
            if unk4 == 0x1 {
                let unk4_5 = reader.read_at_with_ctx(position, &BigEndian)?;
                test_eq(&unk4_5, &0u32)?;
            }
        }
    };
    let unk5 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk5, &0u32)?;
    let unk6 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk6, &0u64)?;
    let unk7 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk7, &0xFFFF_FFFFu64)?;
    let unk8 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk8, &0u32)?;

    let tpl: SplitPath = reader.read_at(position)?;
    #[cfg(not(feature = "fuzz"))]
    {
        test_not(tpl.is_empty())?;
    }
    let unk9 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk9, &0u32)?;

    let components = reader.read_len_type_at_with_ctx::<u32be, _, _>(position, ugi)?.collect::<Result<_, _>>()?;
...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for Component<'de> {
    fn deserialize_at_with_ctx(
        reader: &'de (impl ReadAtExt + ?Sized),
        position: &mut u64,
        ctx: &UniqueGameId,
    ...
    let component_type: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    let component = match component_type {
        ...
        // JD_CreditsComponent
        0x342E_A4FC => Component::CreditsComponent(reader.read_at_with_ctx(position, ctx)?),
        ...
        0x72B6_1FC5 => Component::MaterialGraphicComponent(reader.read_at_with_ctx(position, &(*ctx, false))?),
        // JD_Carousel
        0x27E4_80C0 => todo!("Carousel"),
        // JD_PictoComponent
        0xC316_BF34 => Component::PictoComponent,
        // PleoComponent
        0x1263_DAD9 => Component::PleoComponent(reader.read_at(position)?),
        // PleoTextureGraphicComponent
        0x0579_E81B => Component::PleoTextureGraphicComponent(reader.read_at_with_ctx(position, &(*ctx, true))?),
        // PropertyPatcher
        0xF719_B524 => {
            parse_property_patcher(reader, position, *ctx)?;
        ...
        // UITextBox
        0xD10C_BEED => Component::UITextBox(reader.read_at_with_ctx(position, ctx)?),
...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for CreditsComponent<'de> {
    fn deserialize_at_with_ctx(
        reader: &'de (impl ReadAtExt + ?Sized),
        position: &mut u64,
        ugi: &UniqueGameId,
    ) -> Result<Self, ReadError> {
    let unk11 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    for _ in 0..i {
        let unk12 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_any(
            &unk12,
            &[
                0x41C8_0000u32,
    ...
    let number_of_lines = usize::try_from(reader.read_at_with_ctx::<u32, _>(position, &BigEndian)?)?;
...
fn parse_box_interpolator_component(
    ...
    for _ in 0..2 {
        let unk13 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk13, &0xBF80_0000u32)?;
    }
    for _ in 0..2 {
        let unk14 = reader.read_at_with_ctx(position, &BigEndian)?;
...
fn parse_afx_post_process_component(
    ...
    let unk16 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk16, &8u64)?;
    let unk17 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk17, &1u32)?;
    Ok(())
}
...
fn parse_bezier_tree_component(
    ...
    let unk18 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk18, &2u32)?;
    for _ in 0..4 {
        let unk19 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk19, &0u32)?;
    }
    for _ in 0..2 {
        let unk20 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk20, &0x3F80_0000u32)?;
    }
    for _ in 0..2 {
        let unk21 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk21, &0u32)?;
    }
    let unk22 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk22, &0x4040_0000u32)?;
    for _ in 0..2 {
        let unk23 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk23, &0u32)?;
    }
    for _ in 0..2 {
        let unk24 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk24, &0x3F80_0000u32)?;
    }
    for _ in 0..3 {
        let unk25 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk25, &0u32)?;
    }
    let unk26 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk26, &1u32)?;
    Ok(())
}


impl<'de> BinaryDeserialize<'de, (UniqueGameId, bool)> for MaterialGraphicComponent<'de> {
    fn deserialize_at_with_ctx(
        reader: &'de (impl ReadAtExt + ?Sized),
        position: &mut u64,
        ctx: &(UniqueGameId, bool),
    ) -> Result<Self, ReadError> {
        let (ugi, is_pleo) = *ctx;
    for _ in 0..3 {
        let unk11 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    let unk11_5 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(&unk11_5, &[0x3F80_0000u32, 0x0])?;

    for _ in 0..2 {
        let _unk12: u64 = reader.read_at_with_ctx(position, &BigEndian)?;
    }
    ...
    let unk15 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(
        &unk15,
        &[
            0x0u64,
    ...
    let _unk19: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    match ugi.game {
        Game::JustDance2019 | Game::JustDance2018 | Game::JustDance2017 => {
            let _unk20: u64 = reader.read_at_with_ctx(position, &BigEndian)?;
        },
        _ => {
            for _ in 0..4 {
                let _unk20: u64 = reader.read_at_with_ctx(position, &BigEndian)?;
            ...
            let _unk20_5: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
    
            let _unk21: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
        }
    }

    if ugi.game == Game::JustDance2020 {
        // Just Dance 2020 sometimes has a 0u32 inbetween
        let unk21_5: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
        if unk21_5 != 0 {
            *position -= 4;
        }
    }
    ...
    for _ in 0..3 {
        let _unk23: u32 = reader.read_at_with_ctx(position, &BigEndian)?;
    }

    let _unk24: u32 = reader.read_at_with_ctx(position, &BigEndian)?;

    let _unk25: u64 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    if is_pleo {
        let unk27 = reader.read_at_with_ctx(position, &BigEndian)?;
...
impl<'de> BinaryDeserialize<'de> for PleoComponent<'de> {
    fn deserialize_at_with_ctx(
        ...
        let video = reader.read_at(position)?;
        let dash_mpd = reader.read_at(position)?;
...
impl<'de> BinaryDeserialize<'de, UniqueGameId> for UITextBox<'de> {
    fn deserialize_at_with_ctx(
        reader: &'de (impl ReadAtExt + ?Sized),
        position: &mut u64,
        ugi: &UniqueGameId,
    ...
    let unk23_1 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(&unk23_1, &[0x0u32, 0x4140_0000, 0xC170_0000, 0xC120_0000])?;
    let unk23_2 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk23_2, &0u32)?;
    let unk23_3 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk23_3, &0u32)?;
    let unk23_4 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    let unk23_6 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk23_6, &0u32)?;
    let unk23_7 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk23_7, &0x0u32)?;
    let unk23_8 = reader.read_at_with_ctx(position, &BigEndian)?;
    ...
    for _ in 0..i {
        let unk28 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk28, &0u64)?;
    }
    let unk29 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_eq(&unk29, &0xBF80_0000u32)?;
    if ugi.game == Game::JustDance2019 || ugi.game == Game::JustDance2018 || ugi.game == Game::JustDance2017 {
        let unk30 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk30, &0u32)?;
    } else {
        let unk30 = reader.read_at_with_ctx(position, &BigEndian)?;
        test_eq(&unk30, &0u64)?;
    }
    let unk31 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(&unk31, &[0xFFFF_FFFFu32, 0x1])?;
    let unk32 = reader.read_at_with_ctx(position, &BigEndian)?;
    test_any(&unk32, &[0xFFFF_FFFFu32, 0x1])?;
    let unk33 = reader.read_at_with_ctx(position, &BigEndian)?;
