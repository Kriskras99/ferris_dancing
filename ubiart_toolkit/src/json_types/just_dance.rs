...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "PascalCase", deny_unknown_fields)]
pub struct AvatarDescription<'a> {
    #[serde(rename = "__class", default, skip_serializing_if = "Option::is_none")]
    pub class: Option<&'a str>,
    pub jd_version: u16,
    ...
    pub avatar_id: u16,
    #[serde(
        rename = "UsedAsCoach_MapName",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub used_as_coach_map_name: Option<Cow<'a, str>>,
    #[serde(
        rename = "UsedAsCoach_CoachId",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub used_as_coach_coach_id: Option<u8>,
    #[serde(
