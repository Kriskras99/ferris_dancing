...
pub fn build(
    ...
    let discovery_quest = cooked::isg::ScheduledQuestDesc::from(quest_config.first_discovery_quest);
    ...
    let quest_database = cooked::isg::ScheduledQuestDatabase {
        class: Some(cooked::isg::ScheduledQuestDatabase::CLASS),
        scheduled_quests,
    };
